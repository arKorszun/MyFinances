...
<head>
  ...
  <link rel="stylesheet" href="/assets/addExpense.css">
  <!-- serif font - logo -->
              ...
              <div class="row justify-content-center ">
                <div class="col-9 pt-4">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($expense['amount'] ?? '') ?>" type="text" class="form-control input-place" placeholder="Kwota" aria-label="Kwota"
                      name="expense_amount">
                  </div>
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-9">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($expense['formatted_date'] ?? date("Y-m-d")) ?>" type="date" id="date" class="form-control input-place" aria-label="date"
                      name="expense_date">
                  </div>
                </div>
              </div>
                ...
                <div class="col-9 ">
                  <div class="input-group mb-3 flex-nowrap">
                    ...
                    <select class="custom-select " id="payment-method" name="payment_method">
                      <option selected><?php echo e($expense['payment_method'] ?? '')  ?></option>
                      <?php 
                ...
                <div class="col-9 ">
                  <div class="input-group mb-3 flex-nowrap">
                    ...
                    <select class="custom-select " id="expense-category" name="expense_category">
                      <option selected><?php echo e($expense['expense_category'] ?? '')  ?></option>
              ...
              <div class="row justify-content-center">
                <div class="col-9 ">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($expense['expense_comment'] ?? '') ?>" type="text" class="form-control input-place" placeholder="Komentarz (opcjonalnie)"
              ...
              <div class="row">
                ...
                <div class="col-3 pb-3 text-center">
                  <button type="submit" class="btn btn-primary"
                    style="--bs-btn-padding-y: .15rem; --bs-btn-padding-x: 2rem; --bs-btn-font-size: 1rem;">Aktualizuj
                  </button>

                </div>
                <div class="col-3 pb-3 text-center">
                  <button type="button" class="btn btn-primary" id="cancelbtn" href="./addExpense.php"
                    style="--bs-btn-padding-y: .15rem; --bs-btn-padding-x: 2rem; --bs-btn-font-size: 1rem;">Anuluj
                  </button>
