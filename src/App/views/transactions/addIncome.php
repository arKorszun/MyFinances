          ...
          <div class="container text-panel">
            ...
            <?php include $this->resolve('partials/_csrf.php'); ?>
              <div class="row justify-content-center ">
                <div class="col-9 pt-4">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($oldFormData['income_amount'] ?? '') ?>" type="text" class="form-control input-place" placeholder="Kwota" aria-label="Kwota"
                      name="income_amount">
                  </div>
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-9">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($oldFormData['income_date'] ?? date("Y-m-d")) ?>" type="date" id="date" class="form-control input-place" aria-label="date" name="income_date">
                  </div>
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-9 ">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($oldFormData['income_comment'] ?? '') ?>" type="text" class="form-control input-place" placeholder="Komentarz (opcjonalnie)"
              ...
              <div class="row">
                ...
                <div class="col-3 pb-3 text-center">
                  <button role="button" class="btn btn-primary" id="cancelbtn" href="/addIncome"
