    ...
    <nav class="navbar navbar-expand " aria-label="Second navbar example">
      <div class="container-fluid main-navbar align-items-end ">
        <div class="navbar-brand col-8 px-5 align-bottom">
          <a class="navbar-brand" id="logo" href="/home"><img class="coin" src="/assets/img/piggy-bank.svg" alt="coin icon">
            MyFinances</a>
        </div>
              ...
              <div class="row justify-content-center ">
                <div class="col-9 pt-4">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($oldFormData['username'] ?? '') ?>" type="text" class="form-control input-place" placeholder="Imie" aria-label="Imie"
                      name="username">
                  </div>
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-9">
                  <div class="input-group mb-3">
                    ...
                    <input value="<?php echo e($oldFormData['email'] ?? '') ?>" type="email" class="form-control input-place" placeholder="Email" aria-label="Email"
                      name="email">
                  </div>
                </div>
              </div>
